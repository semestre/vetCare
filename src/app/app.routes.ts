...
export const routes: Routes = [
  // 🔹 Home ES la pantalla de login principal
  {
    path: '',
  ...
  // 🔹 Veterinario
  {
    path: 'veterinario',
    loadComponent: () =>
      import('./components/veterinario/veterinario/veterinario.component').then(
        m => m.VeterinarioComponent
      ),
    children: [
      {
        path: 'paciente',
  ...
  // 🔹 Fallback: cualquier ruta rara te manda a home (login)
